  ...
  <span>
    <strong>Subtotal:</strong>
         ...
         <span>
            ...
            <p>
                <span>Payment Method: </span>{orderDetails.paymentMethod}
            </p>
            {
                orderDetails.paymentMethod ==="UPI" &&(
                    <>
                    <p><span>Razorpay Order Id: </span> {orderDetails.razorpayOrderId}</p>
                        <p><span>Razorpay Payment Id: </span> {orderDetails.razorpayPaymentId}</p>
                    </>
                )
            }
