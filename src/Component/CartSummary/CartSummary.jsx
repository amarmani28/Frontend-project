   ...
   return (
       <div className='mt-2'>
          ...
          <div className='d-flex gap-3'>
             <button className="btn btn-success flex-grow-1" onClick={()=> completePayment("cash")}>{isProcessing ? "Processing...": "Cash"}</button>
          ...
          <div className='d-flex gap-3 mt-3'>
             <button className="btn btn-warning flex-grow-1" onClick={placeOrder} disabled={isProcessing || !orderDetails}>Place Order
             </button>
          </div>
           {
               showPopup && (
